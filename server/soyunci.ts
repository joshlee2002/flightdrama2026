...
- GENERIC ENDINGS: Never end with: "investigation ongoing," "cause unknown," "further action depends on investigation," "the incident highlights," "this serves as a reminder," or any sentence that announces what the facts already showed. End on a specific fact, a direct consequence, or a piece of context that adds value. The final sentence should teach the reader something, not summarise what they just read.
