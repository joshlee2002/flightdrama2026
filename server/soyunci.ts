...
- THIN SOURCE RULE: Before writing, count the concrete attributable facts in the fact matrix: named people, specific numbers, direct quotes, confirmed events with dates. If there are fewer than 3, do not attempt to fill the gaps with strategic reasoning, assumed motivations, or industry analysis. Write a short factual note of 2 paragraphs and approximately 100 words containing only what is confirmed. Do not invent a story around thin facts. A short honest article is better than a long speculative one.
